        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              ...
              associates provide their services to you subject to the following
              conditions. If you visit or shop within this website, you accept
              these conditions. Please read them carefully. ​ PRIVACY Please
              review our Privacy Notice, which also governs your visit to our
              website, to understand our practices. ELECTRONIC COMMUNICATIONS
              ...
              liability for any content posted by you or any third party. RISK
              OF LOSS All items purchased from MYCOMPANY are made pursuant to a
              ...
              PRODUCT DESCRIPTIONS MYCOMPANY and its associates attempt to be as
              accurate as possible. However, MYCOMPANY does not warrant that
              ...
              by MYCOMPANY itself is not as described, your sole remedy is to
              return it in unused condition. DISCLAIMER OF WARRANTIES AND
              LIMITATION OF LIABILITY THIS SITE IS PROVIDED BY MYCOMPANY ON AN
              "AS IS" AND "AS AVAILABLE" BASIS. MYCOMPANY MAKES NO
              ...
              EXTENT PERMISSIBLE BY APPLICABLE LAW, MYCOMPANY DISCLAIMS ALL
              WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO,
              IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR
              PURPOSE. MYCOMPANY DOES NOT WARRANT THAT THIS SITE, ITS SERVERS,
              OR E-MAIL SENT FROM MYCOMPANY ARE FREE OF VIRUSES OR OTHER HARMFUL
              COMPONENTS. MYCOMPANY WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY
              KIND ARISING FROM THE USE OF THIS SITE, INCLUDING, BUT NOT LIMITED
              ...
              HAVE ADDITIONAL RIGHTS. APPLICABLE LAW By visiting MYCOMPANY, you
              agree that the laws of the state of DEFINE_STATE, DEFINE_COUNTRY,
              ...
              arise between you and MYCOMPANY or its associates. DISPUTES Any
              dispute relating in any way to your visit to MYCOMPANY or to
              ...
              proceedings or otherwise. SITE POLICIES, MODIFICATION, AND
              SEVERABILITY Please review our other policies, such as our
              Shipping and Returns policy, posted on this site. These policies
              also govern your visit to MYCOMPANY. We reserve the right to make
              changes to our site, policies, and these Conditions of Use at any
              ...
              any remaining condition. QUESTIONS: Questions regarding our
              Conditions of Usage, Privacy Policy, or other policy related
              material can be directed to our support staff by clicking on the
